    ...
    <tr>
        <td align="center">
            <table width="650" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td align="center" style="padding:40px;background:linear-gradient(135deg,#0B1F33,#00B894);">
                        <h1 style="margin:0;color:white;">LibraStack</h1>
                        <p style="color:#d1fae5;margin:8px 0 0;">Xác nhận trả sách</p>
                    </td>
                </tr>
                <tr>
                    <td style="padding:40px;">
                        ...
                        <p style="font-size:16px;color:#475569;line-height:1.7;">
                            Bạn đã trả thành công cuốn
                            <strong style="color:#00B894;">${bookName}</strong>.
                        </p>
                        <div style="margin:24px 0;padding:20px;background:#f8fafc;border-left:6px solid #00B894;border-radius:10px;">
                        ...
                        <p style="color:#64748b;font-size:14px;">Cảm ơn bạn đã sử dụng LibraStack.</p>
                    </td>
                </tr>
                <tr>
